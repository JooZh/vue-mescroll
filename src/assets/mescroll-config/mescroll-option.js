...
**/
import img from './mescroll-ball.svg';

export default {
	down: {
		htmlContent: `<p class="downwarp-circle"></p><img class="downwarp-ball" src="${img}"/>`, //布局内容
...
//			},
	...
	up: {
		htmlLoading: '<div class="upwarp-loading"><p></p><p></p><p></p><p></p><i></i></div>', //上拉加载中的布局
